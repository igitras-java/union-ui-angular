import { Directive, EventEmitter, Host, HostBinding, HostListener, Input, Optional, Output } from '@angular/core';
import { NgModel } from '@angular/forms';

@Directive({
    selector: '[igFileSelect]',
})
export class IgFileSelectDirective {
