...
import { CovalentFileModule, IgFileDropDirective } from '../file.module';
...
describe('Directive: FileDrop', () => {
  ...
  it('should add/remove class on dragenter and dragleave',
    async(inject([], () => {
      let fixture: ComponentFixture<any> = TestBed.createComponent(IgFileDropBasicTestComponent);
      let component: IgFileDropBasicTestComponent = fixture.debugElement.componentInstance;
      component.multiple = false;
      fixture.detectChanges();
      fixture.whenStable().then(() => {
        let directive: DebugElement = fixture.debugElement.query(By.directive(IgFileDropDirective));
...
@Component({
  selector: 'ig-file-drop-basic-test',
  template: `
  <div igFileDrop
       [multiple]="multiple" 
       [disabled]="disabled"
...
class IgFileDropBasicTestComponent {
  multiple: boolean;
  disabled: boolean;
  files: FileList | File;
}
