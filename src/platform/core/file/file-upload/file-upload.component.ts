...
import { IgFileInputLabelDirective } from '../file-input/file-input.component';

@Component({
    changeDetection: ChangeDetectionStrategy.OnPush,
    selector: 'ig-file-upload',
    styleUrls: ['./file-upload.component.scss'],
    templateUrl: './file-upload.component.html',
})
export class IgFileUploadComponent {
    ...
    @ContentChild(IgFileInputLabelDirective) inputLabel: IgFileInputLabelDirective;
    ...
    /**
     * multiple?: boolean
     * Sets if multiple files can be dropped/selected at once in [IgFileUploadComponent].
     */
    @Input('multiple')
    ...
    /**
     * disabled?: boolean
     * Disables [IgFileUploadComponent] and clears selected/dropped files.
     */
    @Input('disabled')
