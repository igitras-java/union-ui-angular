...
@Directive({
  selector: '[igMessageContainer]',
})
export class IgMessageContainerDirective {
...
export class IgMessageComponent implements AfterViewInit {

  private _color: string;
  private _opened: boolean = true;
  private _initialized: boolean = false;

  @ViewChild(IgMessageContainerDirective) _childElement: IgMessageContainerDirective;
  ...
  constructor(private _renderer: Renderer2,
    ...
    this._renderer.addClass(this._elementRef.nativeElement, 'ig-message');
  }
