...
import { Headers, Http, HttpModule, RequestOptionsArgs, Response, ResponseOptions, XHRBackend } from '@angular/http';
import { Observable } from 'rxjs/Observable';
import { MockBackend, MockConnection } from '@angular/http/testing';
import { HttpConfig, HttpInterceptorService, IgHttpModule, IHttpInterceptor } from '../';
